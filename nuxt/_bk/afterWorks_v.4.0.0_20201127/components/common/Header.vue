      ...
      <div class="head-box">
        <div class="head-logo">
          <div class="logo-box">
            <h1>
              <nuxt-link to="/" exact
                ><img src="/img/img_logo.svg" alt="After Works."
              /></nuxt-link>
            </h1>
          </div>
          <!-- /.logo-box -->
              ...
              <nav>
                <ul>
                  ...
                  <li>
                    <nuxt-link
                      to="/about/"
                      v-on:click.native="closeMenu(false, '/about/')"
                      >About</nuxt-link
                    >
                  </li>
                  <li>
                    <nuxt-link
                      to="/works/"
                      v-on:click.native="closeMenu(false, '/works/')"
                      >Works</nuxt-link
                    >
                  </li>
                  <li>
                    <nuxt-link
                      to="/contact/"
                      v-on:click.native="closeMenu(false, '/contact/')"
                      >Contact</nuxt-link
                    >
                  </li>
                </ul>
...
export default {
  ...
  methods: {
    ...
    // メニューを閉じる処理
    closeMenu: function(isScroll, currentPath) {
      ...
      // スクロールさせない（画面遷移する）場合
      else if (currentPath !== this.$route.path) {
        document
